...
public class lead_deepslate_ore {
    ...
    public static final Block lead_deepslate_ore = register(
            "lead_deepslate_ore",
            Block::new,
    ...
    public static void lead_deepslate_ore_init() {
        ItemGroupEvents.modifyEntriesEvent(ItemGroups.BUILDING_BLOCKS)
                .register((itemGroup) -> itemGroup.add(org.link_uuid.miningContestMod2026.blocks.lead.lead_deepslate_ore.lead_deepslate_ore.asItem()));
    }
}